...
export const emailTemplates = {
  welcome: (name: string, language: string = 'en') => ({
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px;">
          ...
          <p>${language === 'bg' 
            ...
            : 'Thank you for joining eDog - your digital dog passport!'
          }</p>
          <p>${language === 'bg'
            ? 'Вече можете да:'
            : 'You can now:'
  ...
  passwordReset: (resetUrl: string, language: string = 'en') => ({
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px;">
          <p>${language === 'bg' 
            ...
            : 'We received a request to reset your eDog account password.'
          }</p>
          <p>${language === 'bg'
  ...
  appointmentReminder: (dogName: string, appointmentTitle: string, date: string, time: string, language: string = 'en') => ({
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px;">
          <p>${language === 'bg' 
            ...
            : `This is a reminder for ${dogName}'s upcoming appointment:`
          }</p>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px;">
          <p>${language === 'bg' 
            ...
            : `${dogName} has a vaccination due soon:`
          }</p>
          ...
          <p>${language === 'bg'
            ...
            : 'Please contact your veterinarian to schedule an appointment.'
          }</p>
        </div>
      </div>
    `
