  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      while (remainingH > 0) {
        ...
        const yOffset = margin - page * pageH;
        pdf.addImage(imgData, 'PNG', margin, yOffset, imgW, imgH);
        // clip to page area
        pdf.setFillColor(255, 255, 255);
        if (yOffset + imgH > ph - margin) {
          pdf.rect(0, ph - margin, pw, margin + 5, 'F');
        }
        if (page === 0 && yOffset < margin) {
      ...
      pdf.text(`Generated by eDog • ${new Date().toLocaleDateString()}`, pw / 2, ph - 3, { align: 'center' });
    ...
    <div className="font-jakarta bg-[#fbf9f8] dark:bg-[#111316] min-h-full p-4 sm:p-6 lg:p-8 animate-fade-in">
      <style>{`
        @media print {
          ...
          #passport-content .dark\\:bg-\\[\\#111316\\],
          #passport-content .dark\\:bg-\\[\\#1d2026\\],
          #passport-content .dark\\:bg-\\[\\#191c22\\],
          #passport-content .dark\\:bg-\\[\\#1e2023\\],
          #passport-content .dark\\:bg-\\[\\#282a2d\\] {
            background-color: #fff !important;
          }
          #passport-content { max-width: 100% !important; background: #fff !important; }
          /* Remove shadows and glows */
          #passport-content * { box-shadow: none !important; text-shadow: none !important; }
          /* Ensure borders are visible */
          #passport-content .border,
          #passport-content [class*="border-"] { border-color: #e5e7eb !important; }
          /* Page break handling */
          #passport-content .space-y-4 > div,
          #passport-content .space-y-5 > div,
          #passport-content .space-y-6 > div { page-break-inside: avoid; }
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {[
                      ...
                      { label: t('microchip'), value: dog.microchipId || t('notRegistered') },
                    ].map(({ label, value }) => (
