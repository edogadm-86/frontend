    ...
    <div className="flex items-center justify-center p-8 min-h-[60vh]">
      <div className="text-center">
        <div className="w-16 h-16 bg-gray-100 dark:bg-[#282a2d] rounded-2xl flex items-center justify-center mx-auto mb-4">
          <span className="material-symbols-outlined text-gray-400 dark:text-[#414751] text-[32px]">groups</span>
        </div>
        <h2 className="text-xl font-bold text-gray-900 dark:text-[#e2e2e6] mb-2">{t('community')}</h2>
